...
public class LinkedHashMapService {
  ...
  public LinkedHashMap<Integer, User> userMap = new LinkedHashMap<>();

  public LinkedHashMap<Integer, User> getAllUsers() {
    List<User> users;
    ...
    while (namesIterator.hasNext()) {
      ...
      // userMap.put(namesIterator.next().getId(), namesIterator.next());
  ...
  public LinkedHashMap<Integer, User> updateUser(User user, Integer key) {
    User searchedUser = null;
    long startSearchTime = System.nanoTime();
    if (userMap.containsKey(key)) {
